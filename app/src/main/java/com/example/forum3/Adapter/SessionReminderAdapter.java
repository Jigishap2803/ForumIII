...
public class SessionReminderAdapter extends RecyclerView.Adapter< SessionReminderAdapter.MyViewHolder>{
    ...
    public SessionReminderAdapter(Context context, JSONArray data ){
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView session_number_tv,panel_title_tv,session_time_tv;
    ...
    public void onBindViewHolder( MyViewHolder viewHolder, final int position) {
        ...
        try {
            ...
            //viewHolder.session_number_tv.setText("Session" + " " + sessionid);
